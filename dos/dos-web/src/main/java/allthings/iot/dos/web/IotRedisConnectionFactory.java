...
/**
 * @author :  luhao
 * @FileName :  IotRedisConnectionFactory
 * @CreateDate :  2018-5-9
 * @Description :
 * @ReviewedBy :
 * @ReviewedOn :
 ...
 * *******************************************************************************************
 */
public class IotRedisConnectionFactory implements InitializingBean, DisposableBean, RedisConnectionFactory {
    private final static Log log =
            LogFactory.getLog(org.springframework.data.redis.connection.jedis.JedisConnectionFactory.class);
    private static final ExceptionTranslationStrategy EXCEPTION_TRANSLATION =
            new PassThroughExceptionTranslationStrategy(
    ...
    public IotRedisConnectionFactory(JedisSentinelPool jedisSentinelPool) {
        this.jedisSentinelPool = jedisSentinelPool;
    }

    /**
     * Constructs a new <code>JedisConnectionFactory</code> instance with default settings (default connection
     * pooling, no
     * shard information).
     */
    public IotRedisConnectionFactory() {
    }
     ...
     */
    public IotRedisConnectionFactory(JedisShardInfo shardInfo) {
     ...
     */
    public IotRedisConnectionFactory(JedisPoolConfig poolConfig) {
        this(null, poolConfig);
    }

    /**
     * Constructs a new {@link org.springframework.data.redis.connection.jedis.JedisConnectionFactory} instance using
     * the given {@link JedisPoolConfig} applied to
     * {@link JedisSentinelPool}.
     *
     * @param sentinelConfig
     * @since 1.4
     */
    public IotRedisConnectionFactory(RedisSentinelConfiguration sentinelConfig) {
     ...
     * @since 1.4
     */
    public IotRedisConnectionFactory(RedisSentinelConfiguration sentinelConfig, JedisPoolConfig poolConfig) {
    ...
    private Pool<Jedis> createPool() throws Exception {
    ...
    /*
     * (non-Javadoc)
     * @see org.springframework.dao.support.PersistenceExceptionTranslator#translateExceptionIfPossible(java.lang
     * .RuntimeException)
     */
    @Override
    ...
    private Jedis getActiveSentinel() {
        ...
        Assert.notNull(this.sentinelConfig, "[Assertion failed] - this argument is required; it must not be null");
