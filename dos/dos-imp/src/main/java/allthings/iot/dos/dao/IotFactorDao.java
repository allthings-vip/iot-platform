...
public interface IotFactorDao extends BaseRepository<IotFactor, Long> {
    ...
    @Query("select new allthings.iot.dos.dto.query.IotProtocolFactorDTO(factor.iotFactorId, factor.factorName) from " +
            "IotFactor factor where exists (select t.iotFactorId from IotProtocolFactor t " +
    ...
    @Modifying
    @Query(" update IotFactor set isDeleted=true ,modifyOperatorId=:modifyOperatorId where iotFactorId=:iotFactorId and " +
            "isDeleted=false ")
    Integer deleteByIotFactorId(@Param("iotFactorId") Long iotFactorId, @Param("modifyOperatorId") Long modifyOperatorId);


    @Query(" select new allthings.iot.dos.dto.query.IotFactorQueryDTO(t.iotFactorId,t.factorCode,t.factorName," +
    ...
    @Query(" select new allthings.iot.dos.dto.query.IotFactorQueryDTO(t.iotFactorId,t.factorCode,t.factorName,ia" +
