...
public class IotDosServiceTxConfig {
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* allthings.iot.dos.service.*.*(..)) || " +
            "execution(* allthings.iot.dos.open.oauth2.*.*(..)) || execution(* allthings.iot.dos.open.service.*.*(" +
            "..))";
