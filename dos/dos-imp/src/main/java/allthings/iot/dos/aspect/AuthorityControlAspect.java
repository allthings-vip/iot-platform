package allthings.iot.dos.aspect;
...
public class AuthorityControlAspect {
    ...
    @Around("execution(* com.tf56.iot.dos.web.controller.*.save*(..)) " +
            " || execution(* com.tf56.iot.dos.web.controller.*.update*(..)) " +
            "|| execution(* com.tf56.iot.dos.web.controller.*.delete*(..)) " +
            "|| execution(* com.tf56.iot.dos.web.controller.*.import*(..))")
